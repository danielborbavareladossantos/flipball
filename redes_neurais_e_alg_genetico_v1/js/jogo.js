...
obstaculos = {
	...
	atualiza: function() {
		...
		if (estadoAtual == estados.perdeu && flgIa) {

			randomInicializate();
			var npesos = JSON.parse(JSON.stringify(pesos));
			historico.push({pesos:npesos,score:bloco.score});
			label.innerHTML = JSON.stringify(historico[historico.length-1]);
			tf_1.value = historico[historico.length-1].pesos[0].peso;
			tf_2.value = historico[historico.length-1].pesos[1].peso;
			tf_3.value = historico[historico.length-1].pesos[2].peso;
			tf_4.value = historico[historico.length-1].pesos[3].peso;
			tf_5.value = historico[historico.length-1].pesos[4].peso;
			tf_6.value = historico[historico.length-1].pesos[5].peso;
...
function main() {
	...
	tf_1 = document.createElement("input");
	tf_1.type = "range";
	tf_1.min = -1000;
	tf_1.max = 1000;

	tf_2 = document.createElement("input");
	tf_2.type = "range";
	tf_2.min = -1000;
	tf_2.max = 1000;

	tf_3 = document.createElement("input");
	tf_3.type = "range";
	tf_3.min = -1000;
	tf_3.max = 1000;

	tf_4 = document.createElement("input");
	tf_4.type = "range";
	tf_4.min = -1000;
	tf_4.max = 1000;

	tf_5 = document.createElement("input");
	tf_5.type = "range";
	tf_5.min = -1000;
	tf_5.max = 1000;

	tf_6 = document.createElement("input");
	tf_6.type = "range";
	tf_6.min = -1000;
	tf_6.max = 1000;
	...
	document.body.appendChild(tf_1);
	document.body.appendChild(tf_2);
	document.body.appendChild(tf_3);
	document.body.appendChild(tf_4);
	document.body.appendChild(tf_5);
	document.body.appendChild(tf_6);
